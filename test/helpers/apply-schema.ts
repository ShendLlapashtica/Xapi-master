// Applies migrations/0001_init.sql statement-by-statement via prepare().run()
// rather than D1Database.exec() (which has stricter single-line-statement,
// no-comment constraints) so local test runs don't depend on that parser.
// Keep this in sync with migrations/0001_init.sql.
